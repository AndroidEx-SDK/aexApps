...
public class VedioFragment extends DialogFragment implements SurfaceHolder.Callback, View.OnClickListener {
    ...
    private static VedioFragment vedioFragment;
...
//                CameraActivity.this.finish();
    ...
    public VedioFragment dissMissDialog() {
        if (vedioFragment.isVisible()) {
            vedioFragment.dismiss();
            // activity暂停时我们释放相机内存
            clearCamera();
        }
        return this;
