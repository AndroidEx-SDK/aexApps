...
import static com.androidex.aexkk30.OneKeyTextActivity.action_start_print_text;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_NG:
                ...
                Log.e(TAG, "录音失败");
                OneKeyTextActivity.setTextResult("录音失败",true);
                dissMiss();
                break;
            case R.id.btn_OK:
                intent = new Intent(action_start_print_text);
                getContext().sendBroadcast(intent);
                Log.d(TAG, "录音正常");
                OneKeyTextActivity.setTextResult("录音正常",false);
                dissMiss();
                break;
        }
