 ...
 */
JNIEXPORT jint JNICALL Java_com_androidex_devices_aexddMT318Reader_native_Open
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_androidex_devices_aexddMT318Reader_native_Close
  (JNIEnv *, jobject);
