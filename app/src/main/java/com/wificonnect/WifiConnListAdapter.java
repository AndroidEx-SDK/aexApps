...
public class WifiConnListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (i <= 50) {
            level.setBackgroundResource(R.drawable.wifi_05);
        } else if (i > 50 && i <= 65) {
            level.setBackgroundResource(R.drawable.wifi_04);
        } else if (i > 65 && i <= 75) {
            level.setBackgroundResource(R.drawable.wifi_03);
        } else if (i > 75 && i <= 90) {
            level.setBackgroundResource(R.drawable.wifi_02);
        } else {
            level.setBackgroundResource(R.drawable.wifi_01);
        }
